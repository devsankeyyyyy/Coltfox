                    ...
                    <div className="mt-7 bg-white flex flex-col">
                        <div className="menu-1 pt-5 pl-5 pr-5 flex items-center">
                            ...
                            <svg
                                ...
                                className={`dropdown-menu1 cursor-pointer ml-auto mr-4 transform transition-transform duration-300 ${dropdownsOpen.menu1 ? 'rotate-180' : 'rotate-0'}`}
                        ...
                        <div className="menu-2 pt-5 pl-5 pr-5 flex items-center">
                            ...
                            <svg
                                ...
                                className={`dropdown-menu2 cursor-pointer ml-auto mr-4 transform transition-transform duration-300 ${dropdownsOpen.menu2 ? 'rotate-180' : 'rotate-0'}`}
                                width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"
                            >
                                {dropdownsOpen.menu2 ? (
                                    // svg for "-" 
                        ...
                        <div className="menu-3 pt-5 pl-5 pr-5 flex items-center">
                            ...
                            <svg
                                ...
                                className={`dropdown-menu3 cursor-pointer ml-auto mr-4 transform transition-transform duration-300 ${dropdownsOpen.menu3 ? 'rotate-180' : 'rotate-0'}`}
                                width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"
                            >
                                {dropdownsOpen.menu3 ? (
                                    // svg for "-" 
                        ...
                        <div className="menu-4 pt-5 pl-5 pr-5 flex items-center">
                            ...
                            <svg
                                ...
                                className={`dropdown-menu4 cursor-pointer ml-auto mr-4 transform transition-transform duration-300 ${dropdownsOpen.menu4 ? 'rotate-180' : 'rotate-0'}`}
                                width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"
                            >
                                {dropdownsOpen.menu4 ? (
                                    // svg for "-" 
                        ...
                        <div className="menu-5 pt-5 pl-5 pr-5 flex items-center">
                            ...
                            <svg
                                ...
                                className={`dropdown-menu5 cursor-pointer ml-auto mr-4 transform transition-transform duration-300 ${dropdownsOpen.menu5 ? 'rotate-180' : 'rotate-0'}`}
                                width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"
                            >
                                {dropdownsOpen.menu5 ? (
                                    // svg for "-" 
                        ...
                        <div className="menu-6 pt-5 pl-5 pr-5 flex items-center">
                            ...
                            <svg
                                ...
                                className={`dropdown-menu6 cursor-pointer ml-auto mr-4 transform transition-transform duration-300 ${dropdownsOpen.menu6 ? 'rotate-180' : 'rotate-0'}`}
                                width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg"
                            >
                                {dropdownsOpen.menu6 ? (
                                    // svg for "-" 

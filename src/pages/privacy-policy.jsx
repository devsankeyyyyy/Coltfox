...
const Privacypolicy = () => {
    ...
    return (
        <div className='bg-[#F2F2F2]'>
            ...
            <div className="acma mt-10 px-3 pb-14 text-center sm:px-20 text-[#DF2323] text-6xl sm:text-[6rem] font-semibold leading-tight">
                <h1> PRIVACY POLICY </h1>
            </div>

            <img className='w-full' src='./policy-main.png' alt='per-marketing-main' />
